...
| **LMS Connector** | Node.js | `3001` | Synchronisation avec les APIs Moodle. |
| **PrepaData** | Python / Airflow | `8001` | Pipeline ETL automatisé et Feature Engineering. |
...
| **RecoBuilder** | Python / BERT | `8003` | Moteur de recommandation sémantique. |
...
3.  **Initialiser les données de recommandation** (Optionnel) :
    ```bash
    # Nécessite Python et la bibliothèque 'requests' localement
